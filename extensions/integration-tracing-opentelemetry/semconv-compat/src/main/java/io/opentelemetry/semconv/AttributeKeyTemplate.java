 ...
 *
 * <p>
 * An example template-type attribute is the set of attributes for HTTP headers:
...
public final class AttributeKeyTemplate<T> {
     ...
     *
     * <p>
     * {@link AttributeKey} objets are being created and cached on the first invocation of this
