 ...
 */
public class ConfiguredLoggingFeatureTest {
    ...
    static final QuarkusUnitTest TEST = new QuarkusUnitTest()
            ...
            .overrideConfigKey("quarkus.cxf.endpoint.\"/hello\".logging.pretty", "true")
            ...
            .overrideConfigKey("quarkus.cxf.client.hello.logging.pretty", "false")
            ...
            .assertLogRecords(records -> assertThat(records)
                    ...
                    .anyMatch(msg -> msg.contains(
                            /* Client out message is not pretty */
                    ...
                    .anyMatch(msg -> msg.contains(
                            /* Client in message is not pretty */
