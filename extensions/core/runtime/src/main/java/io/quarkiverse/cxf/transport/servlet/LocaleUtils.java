...
public class LocaleUtils {
    ...
    static class QValueParser {
        ...
        private static QValueResult handleNewEncoding(final List<QValueResult> found, final String header,
                final int stringStart, final int i) {
        ...
        public static class QValueResult implements Comparable<QValueResult> {
            ...
            public int compareTo(final QValueResult other) {
                ...
                for (int i = 0; i < 5; ++i) {
                    ...
                    if (i == 1)
                        continue; // this is just the decimal point
