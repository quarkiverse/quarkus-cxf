 ...
 * {@link CxfTlsConfiguration} is only used for configuring {@link VertxHttpClientHTTPConduit}.
 * Other kinds of conduits are configured only via {@link TLSClientParameters}.
 */
