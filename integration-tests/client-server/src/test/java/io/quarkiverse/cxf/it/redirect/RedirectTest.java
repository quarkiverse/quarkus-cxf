        ...
        getResponse(endpoint, sizeBytes)
                ...
                .body(
                        CoreMatchers.either(
                                ...
                                .or(Matchers.matchesPattern(
                                        "\\QRedirect loop detected on Conduit '{https://quarkiverse.github.io/quarkiverse-docs/quarkus-cxf/test}LargeSlowServicePort.http-conduit' on 'http://localhost:\\E[0-9]+\\Q/RedirectRest/selfRedirect/2/2'\\E")));
    }
