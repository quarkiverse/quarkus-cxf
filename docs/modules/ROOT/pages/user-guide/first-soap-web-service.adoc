...
TIP: All configuration properties are documented in the xref:reference/extensions/quarkus-cxf.adoc#_configuration[Configuration properties] reference.
...
TIP: Try to do that while Quarkus dev mode is running.
