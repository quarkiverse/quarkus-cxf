...
The functionality is provided by `xref:reference/extensions/quarkus-cxf-rt-ws-security.adoc#quarkus-cxf-rt-ws-security[quarkus-cxf-rt-ws-security]` extension.
