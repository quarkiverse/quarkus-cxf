...
Follow the xref:user-guide/contract-first-code-first/generate-java-from-wsdl.adoc#generate-java-from-wsdl[Generate the Model classes from WSDL] section of the user guide
...
When implementing a service the xref:user-guide/contract-first-code-first/generate-java-from-wsdl.adoc#generate-java-from-wsdl[generation of Java code from WSDL]
...
2. xref:user-guide/contract-first-code-first.adoc#contract-first-code-first[Generate the WSDL document from Java] classes at build time
