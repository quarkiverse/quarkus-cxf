...
Our introductory guides for Quarkus xref:user-guide/first-soap-client.adoc#first-soap-client[SOAP client]
and xref:user-guide/first-soap-web-service.adoc#first-soap-web-service[SOAP service] dealt with services
