...
[TIP]
====
If you want to use this approach, first follow the xref:user-guide/contract-first-code-first/generate-java-from-wsdl.adoc#generate-java-from-wsdl[Generate Java from WSDL] section and then continue with the next steps.
====
...
* xref:user-guide/package-for-jvm-and-native.adoc#package-for-jvm-and-native[Package for JVM and native].
* xref:user-guide/advanced-soap-client-topics.adoc#advanced-soap-client-topics[Advanced client topics]
