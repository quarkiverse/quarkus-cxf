...
To use WSS4J interceptors in your code, you should first add the Quarkus CXF WS-Security dependency.  The benefit of using this module is that will be able to build and run a native executable.
