...
When using the xref:release-notes/rn-3-13-0.adoc[new `VertxHttpClientHTTPConduitFactory`],
...
xref:reference/extensions/quarkus-cxf.adoc[configuration]
xref:reference/extensions/quarkus-cxf-rt-ws-security.adoc[options].
