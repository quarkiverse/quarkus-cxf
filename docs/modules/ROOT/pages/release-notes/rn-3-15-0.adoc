...
and making CXF aware of it via the new `xref:reference/extensions/quarkus-cxf-rt-features-metrics.adoc[quarkus.cxf.metrics.tags-customizers]` configuration property.
