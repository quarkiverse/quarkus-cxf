...
* Build time configuration options, such as `xref:reference/extensions/quarkus-cxf.adoc[quarkus.cxf.codegen.wsdl2java.*]` were missing in on the `quarkus-cxf` reference page due to a bug in our tooling.
