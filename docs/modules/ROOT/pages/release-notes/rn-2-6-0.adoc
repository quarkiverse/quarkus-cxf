...
xref:reference/extensions/quarkus-cxf.adoc[configuration options] were moved to `io.quarkiverse.cxf:quarkus-cxf` extension.
...
We are continually improving the test coverage of the xref:reference/extensions/quarkus-cxf-rt-ws-security.adoc[WS-Security configuration options].
