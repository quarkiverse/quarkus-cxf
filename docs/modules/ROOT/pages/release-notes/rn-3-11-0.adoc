...
You can read more about `@CXFEndpoint` in the new chapter of {quarkus-cxf-project-name} called xref:user-guide/advanced-service-topics/endpoints-and-paths.adoc#endpoints-and-paths[Service endpoints and paths].
