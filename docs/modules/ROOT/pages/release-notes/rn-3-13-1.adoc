...
We introduced xref:release-notes/rn-3-13-0.adoc#_vert_x_httpclient_based_http_conduit[Vert.x HttpClient based HTTP Conduit] in {quarkus-cxf-project-name} 3.13.0
