...
** xref:user-guide/contract-first-code-first.adoc#contract-first-code-first[Contract first and code first approaches]
** xref:user-guide/interceptors-features-handlers.adoc#interceptors-features-handlers[CXF Interceptors and Features, JAX-WS Handlers]
** xref:user-guide/advanced-service-topics.adoc#advanced-service-topics[Advanced service topics]
** xref:user-guide/advanced-soap-client-topics.adoc#advanced-soap-client-topics[Advanced SOAP client topics]
* New chapters:
** xref:user-guide/advanced-client-topics/cdi-scope-of-cxfclient.adoc#cdi-scope-of-cxfclient[CDI scope of clients injected via `@CXFClient`] - see also https://github.com/quarkiverse/quarkus-cxf/issues/1441[#1441]
