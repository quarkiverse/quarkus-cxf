...
The directory where the xref:user-guide/generate-java-from-wsdl.adoc[`wsdl2java` embedded in `quarkus-cxf`] extension produces the Java classes is now configurable
...
For more information, see xref:user-guide/advanced-soap-client-topics.adoc#resource-leaks[Prevent resource leaks] section of the user guide.
...
* New xref:user-guide/running-behind-a-reverse-proxy.adoc[X-Forwarded support] page
