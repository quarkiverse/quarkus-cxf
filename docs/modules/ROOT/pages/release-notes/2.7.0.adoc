...
after we have added a proper https://github.com/quarkiverse/quarkus-cxf/tree/2.7.0/integration-tests/metrics[test],
a basic xref:reference/extensions/quarkus-cxf-rt-features-metrics.adoc#quarkus-cxf-rt-features-metrics-usage[Usage guide]
and xref:reference/extensions/quarkus-cxf-rt-features-metrics.adoc#quarkus-cxf-rt-features-metrics-configuration[Configuration options].
