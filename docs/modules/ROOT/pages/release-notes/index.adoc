...
* Which {quarkus-cxf-project-name} version is available in which Quarkus Platform version
* Which {quarkus-cxf-project-name} version depends on which CXF version

[%autowidth,stripes=hover]
|===
| Quarkus CXF | Release date | Quarkus Platform | CXF

| xref:release-notes/3.13.0.adoc[3.13.0] | 2024-07-25 | 3.13 | 4.0.4
