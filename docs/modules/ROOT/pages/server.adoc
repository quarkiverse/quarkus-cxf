...
CXF generate the WSDL for each SOAP webservice then you can access wsdl just by adding "?wsdl" at end of service url.
...
You can use annotation to modified element(name, namespace,...) in SOAP.
...
If you start from Java code, here is the https://cxf.apache.org/docs/developing-a-service.html#DevelopingaService-JavaFirstDevelopment[documentation of annotation to customize web-service]
